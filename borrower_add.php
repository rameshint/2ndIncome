            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Adding new Borrower</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="borrower_save.php" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputTel2">Referer Name</label>
                                <input type="text" name="referenced_by" class="form-control" id="exampleInputTel2" placeholder="Enter Referred Name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputTel2">Referrer Contact No</label>
                                <input type="tel" name="referenced_contactno" class="form-control" id="exampleInputTel2" placeholder="Enter Referrer Contact No">
                            </div>
                            <div class="form-group">
